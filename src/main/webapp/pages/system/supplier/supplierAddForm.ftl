...
<title>供应商管理页面</title>
<@headMacro.headMacro/>
<script type="text/javascript" src="${rc.contextPath}/js/system/supplier/supplierAddForm.js"></script>
</head>
<body>
...
<div>
	<div class="m_cont">
		<div class="form_div">
			...
			<form id="checkForm" action="${rc.contextPath}/supplier/saveSupplier" method="post">
				<table class="inputTable">
					...
					<tr>
						...
						<td >
							<input name="supCode" type="text" class="inp_text easyui-validatebox" required="true"/>
						</td>
					...
					<tr>
						...
						<td >
							<input name="supName" type="text" class="inp_text easyui-validatebox" required="true"/>
						</td>
						<td class="title"><span class="txt-impt">*</span>&nbsp;供应商地址：</td>
						<td >
							<input name="supAddress" type="text" class="inp_text easyui-validatebox" data-options="required:true"/>
						</td>
					</tr>
					<tr>
						<td class="title"><span class="txt-impt">*</span>&nbsp;联系电话：</td>
						<td >
							<input name="supPhone" type="text" class="inp_text easyui-validatebox" required="true"/>
						</td>
						<td class="title"><span class="txt-impt">*</span>&nbsp;供应商邮编：</td>
						<td >
							<input name="supPostCode" type="text" class="inp_text easyui-validatebox" data-options="required:true"/>
						</td>
					</tr>
				</table>
				...
				<table class="inputTable">
					<thead>
						<tr><td><span class="steps_2_on"></span>选择所属机构</td></tr>
					</thead>
				</table>
			...
			<div class="buttonArea">
				<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="supplierAddForm.submit();">提交</a>
				<a href="#" class="easyui-linkbutton" iconCls="icon-redo" onclick="supplierAddForm.reset();">重置</a>
			</div>
