...
<script type="text/javascript" src="${rc.contextPath}/js/system/role/roleAddForm.js"></script>
</head>
<body>
	...
	<div class="m_cont">
		<div class="form_div">
			...
			<div class="buttonArea">
				<a href="#" class="easyui-linkbutton" iconCls="icon-ok" onclick="roleAddForm.submit();">提交</a>
				<a href="#" class="easyui-linkbutton" iconCls="icon-redo" onclick="roleAddForm.reset();">重置</a>
			</div>
			<form id="submitForm" action="${rc.contextPath}/system/role/saveRole" method="post">
